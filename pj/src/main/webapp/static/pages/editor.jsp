<link href="<%=request.getContextPath()%>/frames/ueditor/themes/default/css/umeditor.css" type="text/css" rel="stylesheet">
<script type="text/javascript" src="<%=request.getContextPath()%>/frames/ueditor/third-party/jquery.min.js"></script>
